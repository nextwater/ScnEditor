...
import org.sim.test.db.facade.AAgent1Facade;
 ...
 * @author g
 */
@WebServlet(name = "CreateAgent1", urlPatterns = {"/CreateAgent1"})
public class CreateAgent1 extends HttpServlet {
